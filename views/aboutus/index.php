				...
				<tr>
					...
					<td style="vertical-align:top;">
						<table align="left" width=600>
							...
							<tr>
								<td class="item" style="width:510px;">Writer, Director and Producer of "F*** I’m Pregnant", "Sophie's Revenge", "Sailfish" and the award-winning short film "The
		...
		<div class="slider">
			...
			<div class="slider_inner">
				<ul class="comm_list clearfix">
					<li><a href="/views/large?i=5&f=8" target="_blank" class="imgs_box"><img src="/public/images/s/8/img_5.jpg" class="img_box"></a></li>
